        ...
        <div className="min-h-screen bg-gradient-to-b from-dark-900 to-black text-white px-4 py-8 md:px-16 font-sans relative overflow-hidden">
            ...
            >
                ...
                <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
                    Weaver blends on-chain retention with campaigns while providing traction analytics
                    and AI-powered insights for next-level growth.
                </p>
                ...
                >
                    ...
                    >
                        ...
                        <div className="absolute bottom-4 left-4 text-white text-base font-medium">Retention Dashboard</div>
                    </motion.div>
                </motion.div>
            </motion.header>
                    ...
                    <Card>
                        <CardContent className="space-y-4">
                            ...
                            <p className="text-gray-300">
                                ...
                                for protocols, portable user retention mechanics.
                            </p>
                        </CardContent>
                    </Card>
                </motion.div>
