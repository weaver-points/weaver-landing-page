...
export default function App() {
  ...
  const handleSubmit = async () => {
    if (!email || !name || (role === "project" && !description)) {
      setFeedback({
        type: "error",
    ...
    const { error } = await supabase.from("waitlist").insert([
      {
        ...
        role,
        name,
        network: role === "project" ? network : null,
        description: role === "project" ? description : null,
      },
    ]);
    ...
    <div className="min-h-screen bg-gradient-to-b from-dark-900 to-black text-white px-4 py-8 md:px-16 font-sans relative overflow-hidden">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
          Weaver blends on-chain retention with campaigns while providing
          traction analytics and AI-powered insights for next-level growth.
        </p>
        ...
        >
          ...
          >
            ...
            <div className="absolute bottom-4 left-4 text-white text-base font-medium">
              Retention Dashboard
            </div>
          </motion.div>
        </motion.div>
          ...
          <Card>
            <CardContent className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-2xl font-bold text-white">Why Weaver?</h2>
              </div>
              <p className="text-gray-300">
                Protocols struggle to know which users matter. Users lack
                credibility when jumping between dapps. Weaver solves both:
                measurable traction for protocols, portable user retention
                mechanics.
              </p>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  {
                    text: "User retention through on-chain campaigns",
          ...
          >
            ...
            <div className="absolute bottom-8 left-8 max-w-md">
              ...
              <p className="text-gray-200 text-sm">
                Real-time data visualization and insights to help protocols
                understand user behavior and optimize campaigns.
              </p>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          <Card>
            <CardContent className="space-y-4">
              ...
              <p className="text-gray-300">
                Weaver's AI engine reviews engagement trends and recommends
                campaign tweaks. From targeting dormant users to boosting
                onboarding conversion—your traction engine just got smarter.
              </p>
            </CardContent>
          </Card>
        </motion.div>
            ...
            <Card className="bg-gradient-to-br from-dark-800 to-dark-900 border-primary/20">
              <CardContent className="space-y-4">
                ...
                <p className="text-gray-300">
                  ...
                  people have joined the waitlist. Sign up to join our growing
                  traction community.
                </p>
        ...
        >
          <div className="md:w-1/2 order-2 md:order-1 p-8 flex flex-col justify-center bg-gradient-to-r from-dark-800 to-transparent">
            ...
            <p className="text-gray-300 mb-6">
              Launch, track, and optimize targeted campaigns with our AI-powered
              platform. Customize rewards and track user engagement in
              real-time.
            </p>
            <div>
      ...
      <footer className="relative z-10 py-6 border-t border-dark-600 mt-16">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-3">
            <img src={Badge} alt="Starknet Ecosystem" className="w-16" />
            <p className="text-gray-400">Backed by the Starknet Ecosystem</p>
          </div>
